...
<h2> Overview </h2>
This is a pixelart coffee themed productivity timer. <br>
It let's you choose between four coffee types, each representing a different focus session length. <br>
